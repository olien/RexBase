...
$REX['ADDON']['plugins']['watson']['install']['watson_calculator'] = '0';
$REX['ADDON']['plugins']['watson']['status']['watson_calculator'] = '0';
...
$REX['ADDON']['plugins']['xform']['install']['geo'] = '1';
$REX['ADDON']['plugins']['xform']['status']['geo'] = '1';
...
$REX['ADDON']['plugins']['xoutputfilter']['install']['abbrev'] = '0';
$REX['ADDON']['plugins']['xoutputfilter']['status']['abbrev'] = '0';

$REX['ADDON']['plugins']['xoutputfilter']['install']['acronym'] = '0';
$REX['ADDON']['plugins']['xoutputfilter']['status']['acronym'] = '0';

$REX['ADDON']['plugins']['xoutputfilter']['install']['backend'] = '0';
$REX['ADDON']['plugins']['xoutputfilter']['status']['backend'] = '0';

$REX['ADDON']['plugins']['xoutputfilter']['install']['frontend'] = '1';
$REX['ADDON']['plugins']['xoutputfilter']['status']['frontend'] = '1';

$REX['ADDON']['plugins']['xoutputfilter']['install']['import_export'] = '0';
$REX['ADDON']['plugins']['xoutputfilter']['status']['import_export'] = '0';

$REX['ADDON']['plugins']['xoutputfilter']['install']['languages'] = '1';
$REX['ADDON']['plugins']['xoutputfilter']['status']['languages'] = '1';
// --- /DYN
// ----------------- /DONT EDIT BELOW THIS