...
INSERT INTO `rex_420_xoutputfilter` VALUES 
  ...
  (3,4,1,'Beispiel_006','Leere HTML-Tags entfernen (<p>, <span>, <strong>, <b>, <em>, <h1>, <h2>, <h3>, <h4>, <h5>, <h6>)',0,'/<(p|span|strong|b|em|h1|h2|h3|h4|h5|h6)>(\\s|\\b)*<\\/\\1>/','',1,1,0,'',3,'','','','0000-00-00 00:00:00','0000-00-00 00:00:00'),
...
INSERT INTO `rex_630_cronjobs` VALUES 
  (1,'Artikel-Status','rex_cronjob_article_status','a:0:{}','|1|d|',1396047600,'|0|1|',1,1386855143,'olien',1386855163,'olien');
...
INSERT INTO `rex_article` VALUES 
  (1,1,0,'Starseite','Starseite',1,'',1,1,'|',1,1386851172,1396003937,1,0,'olien','olien',0,'','','','','','','','','','',''),
  (3,2,0,'404 Seite','',0,'',0,1,'|',1,1386851132,1387189784,1,0,'olien','olien',0,'','','','','','','','','','',''),
  ...
  (7,5,0,'Noch einer','Noch einer',2,'',1,1,'|',1,1396002895,1387187827,1,0,'olien','olien',0,'','','','','','','','','','',''),
  (8,6,0,'Noch einer mehr','Noch einer mehr',3,'',1,1,'|',1,1387187841,1387189764,1,0,'olien','olien',0,'','','','','','','','','','',''),
...
INSERT INTO `rex_article_slice` VALUES 
  (1,0,1,0,'1. Überschrift','h1','Text','','','','l','noresize','1','','','','nurbildlink','','','','','30.12.2014','26.06.2014','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',1,2,1386854778,1396003937,'olien','olien',0,0,1),
  (2,0,1,1,'2. Überschrift','h2','Noch mehr Text','','','','l','noresize','','','','','nurbildlink','','','','','26.12.2014','06.10.2013','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',1,2,1386854791,1396003859,'olien','olien',0,0,1),
  (4,0,1,0,'Seite nicht gefunden','h1','','','','','l','noresize','','','','','nurbildlink','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',2,2,1387189784,1387189784,'olien','olien',0,0,1);
...
INSERT INTO `rex_rexpixel` VALUES 
  (1,'aus','eingeloggte','aktiv','rex_pixel_default.jpg','rex_pixel_default.jpg','768',40,733,50,'close',0,'center');
